...
\address{Technical Lead, DevOps Team\\
...
\begin{category}{Technical Skills}
  ...
  \citembullet {\it Programming Languages}: Ruby, Python, JavaScript, HTML5, CSS3,
  Objective C, Java, C\# .NET.
  \citembullet {\it Frameworks}: Ruby on Rails, ASP.NET, jQuery, RSpec, Jasmine.
  \citembullet {\it Databases}: MySQL, PostgreSQL, MongoDB, Redis.
  \citembullet {\it Tools}: Alexa, Backbone.js, Sinon.js, jsTestDriver,
  Jenkins, Capistrano.
  \citembullet {\it Version Control}: Git, AWS CodeCommit, Github, Gitlab
  \citembullet {\it Cloud Platforms}: AWS, Google App Engine, Openstack.
  \citembullet {\it Specialities}: Ruby on Rails, AWS, Node.js, NoSQL databases, Web services, DevOps, Automation \& deployment,
...
\begin{category}{Work \\experience}
  \citem{Idexcel Technologies Pvt Ltd, Bangalore}
...
\begin{category}{Awards \&\\ Honours}
  \citem{``Star Performer of the Month''}, {\em
    DevOps Team, Idexcel, Bangalore}. \hfill \textbf{Nov-2018}
  \citem{``AWS Certified Developer - Associate Level''}, {\em
